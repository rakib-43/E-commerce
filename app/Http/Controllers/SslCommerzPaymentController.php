...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $update_product = DB::table('order_models')
    ...
    public function anotherpayment(){
        $post_data = array();
        $post_data['total_amount'] = "120"; # You cant not pay less than 10
        $post_data['currency'] = "BDT";
        $post_data['tran_id'] = uniqid(); // tran_id must be unique

        # CUSTOMER INFORMATION
        $post_data['cus_name'] = "Ahsan Arafat";
        $post_data['cus_email'] = "oytizo.bd@gmail.com";
        $post_data['cus_add1'] = "Dhanmonddi";
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = "";
        $post_data['cus_state'] = "";
        $post_data['cus_postcode'] = "";
        $post_data['cus_country'] = "Bangladesh";
        $post_data['cus_phone'] = "01723244858";
        $post_data['cus_fax'] = "";
