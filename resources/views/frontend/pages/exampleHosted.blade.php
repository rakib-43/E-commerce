...
<div class="container">
    ...
    <div class="row">
        ...
        <h4 class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span class="badge badge-secondary badge-pill">{{ $addcart->count() }}</span>
                </h4>
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            <h6 class="my-2 mx-2">{{ $someproduct->name }}</h6>
                            <img src="{{ asset('backend/product_image/'.$someproduct->image) }}" style="width: 50px;" alt="">
                        </div>
                        <span class="text-muted">{{ $someproduct->price }}TK</span>
                    </li>
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <input type="hidden" value="{{ $total_price }}" name="amount" id="total_amount" required/>
                ...
                <hr class="mb-4">
                <a href="{{ Route('cart') }}" class="btn btn-secondary btn-lg btn-block" type="submit">Back to Cart</a>
